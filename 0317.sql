...
SELECT EMPNO, ENAME, HIREDATE,
       CASE WHEN COMM IS NULL THEN 'N/A' ELSE COMM END AS COMM
FROM EMP
WHERE COMM IS NULL
  AND HIREDATE + INTERVAL 3 MONTH = 
      (SELECT MIN(DATEADD(day, (DATEDIFF(day, '1900-01-07', HIREDATE)/7)*7 + 6, '1900-01-07'))
       FROM EMP
